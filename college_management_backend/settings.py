"""
Django settings for college_management_backend project.
...
SECRET_KEY = 'django-insecure-0*kdk0#0c06q(f)exi6)jfhbp&yfe0p*!b)k7h#!1vtw!!@hki'
...
WSGI_APPLICATION = 'college_management_backend.wsgi.application'
